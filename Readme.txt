for starting the frontend part


1. npm install (for installing all the dependancy)
2. npm start (already mention in package.json regarding the start script therefore you only need to hit npm start)
